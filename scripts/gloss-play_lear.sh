#!/bin/bash
# gloss-play_lear.sh - Analyze the entirety of King Lear
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_lear.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== King Lear - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
