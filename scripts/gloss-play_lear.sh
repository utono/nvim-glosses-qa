#!/bin/bash
# gloss-play_lear.sh - Analyze the entirety of Lear
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_lear.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/lear_gut.txt"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/lear/"
    exit 0
fi
