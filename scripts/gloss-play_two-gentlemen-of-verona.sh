#!/bin/bash
# gloss-play_two-gentlemen-of-verona.sh - Analyze the entirety of Two Gentlemen of Verona
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_two-gentlemen-of-verona.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/two_gentlemen_of_verona_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Two Gentlemen of Verona - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Two Gentlemen of Verona - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing Two Gentlemen of Verona..."
echo "Play file: $PLAY"
...
echo "Play: Two Gentlemen of Verona"
echo "Total scenes: $TOTAL_SCENES"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/two-gentlemen-of-verona/"
    exit 0
fi
