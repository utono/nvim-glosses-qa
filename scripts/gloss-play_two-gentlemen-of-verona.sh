#!/bin/bash
# gloss-play_two-gentlemen-of-verona.sh - Analyze the entirety of The Two Gentlemen of Verona
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_two-gentlemen-of-verona.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== The Two Gentlemen of Verona - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== The Two Gentlemen of Verona - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing The Two Gentlemen of Verona..."
echo "Play file: $PLAY"
...
echo "Play: The Two Gentlemen of Verona"
echo "Total scenes: $TOTAL_SCENES"
