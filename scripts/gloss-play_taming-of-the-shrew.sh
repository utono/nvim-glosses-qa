#!/bin/bash
# gloss-play_taming-of-the-shrew.sh - Analyze the entirety of The Taming of the Shrew
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_taming-of-the-shrew.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== The Taming of the Shrew - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== The Taming of the Shrew - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing The Taming of the Shrew..."
echo "Play file: $PLAY"
...
echo "Play: The Taming of the Shrew"
echo "Total scenes: $TOTAL_SCENES"
