#!/bin/bash
# gloss-play_taming-of-the-shrew.sh - Analyze the entirety of Taming of the Shrew
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_taming-of-the-shrew.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Taming of the Shrew - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Taming of the Shrew - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
