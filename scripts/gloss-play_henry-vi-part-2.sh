#!/bin/bash
# gloss-play_henry-vi-part-2.sh - Analyze the entirety of Henry Vi Part 2
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_henry-vi-part-2.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Henry Vi Part 2 - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Henry Vi Part 2 - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
