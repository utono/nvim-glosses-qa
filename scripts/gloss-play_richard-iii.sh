#!/bin/bash
# gloss-play_richard-iii.sh - Analyze the entirety of Richard Iii
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_richard-iii.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/richard_iii_gut.txt"
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Richard Iii - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/richard-iii/"
    exit 0
fi
