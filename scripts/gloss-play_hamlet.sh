#!/bin/bash
# gloss-play_hamlet.sh - Analyze the entirety of Hamlet
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_hamlet.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/hamlet_gut.txt"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/hamlet/"
    exit 0
fi
