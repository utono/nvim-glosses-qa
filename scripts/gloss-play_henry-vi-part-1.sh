#!/bin/bash
# gloss-play_henry-vi-part-1.sh - Analyze the entirety of Henry Vi Part 1
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_henry-vi-part-1.sh [OPTIONS] [FILTER]
#
# Options:
...
#   - Acts: 1, 2, 3, 4, 5
#   - Epilogue: no
#   - Total output files: 27

PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/henry_vi_part_1_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Henry Vi Part 1 - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Henry Vi Part 1 - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing Henry Vi Part 1..."
echo "Play file: $PLAY"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/henry-vi-part-1/"
    exit 0
fi
