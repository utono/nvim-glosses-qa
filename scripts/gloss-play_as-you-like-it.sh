#!/bin/bash
# gloss-play_as-you-like-it.sh - Analyze the entirety of As You Like It
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_as-you-like-it.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== As You Like It - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== As You Like It - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/as-you-like-it/"
    exit 0
fi
