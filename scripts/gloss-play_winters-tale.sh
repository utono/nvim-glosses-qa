#!/bin/bash
# gloss-play_winters-tale.sh - Analyze the entirety of Winters Tale
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_winters-tale.sh [OPTIONS] [FILTER]
#
# Options:
...
#   - Acts: 1, 2, 3, 4, 5
#   - Epilogue: no
#   - Total output files: 15

PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/winters_tale_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Winters Tale - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Winters Tale - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/winters-tale/"
    exit 0
fi
