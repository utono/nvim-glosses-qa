#!/bin/bash
# gloss-play_richard-ii.sh - Analyze the entirety of Richard Ii
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_richard-ii.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/richard_ii_gut.txt"
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Richard Ii - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/richard-ii/"
    exit 0
fi
