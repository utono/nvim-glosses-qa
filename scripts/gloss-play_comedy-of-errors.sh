#!/bin/bash
# gloss-play_comedy-of-errors.sh - Analyze the entirety of The Comedy of Errors
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_comedy-of-errors.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== The Comedy of Errors - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== The Comedy of Errors - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing The Comedy of Errors..."
echo "Play file: $PLAY"
...
echo "Play: The Comedy of Errors"
echo "Total scenes: $TOTAL_SCENES"
