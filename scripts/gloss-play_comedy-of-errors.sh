#!/bin/bash
# gloss-play_comedy-of-errors.sh - Analyze the entirety of Comedy of Errors
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_comedy-of-errors.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Comedy of Errors - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Comedy of Errors - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
