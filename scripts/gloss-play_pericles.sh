#!/bin/bash
# gloss-play_pericles.sh - Analyze the entirety of Pericles
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_pericles.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/pericles_gut.txt"
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Pericles - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/pericles/"
    exit 0
fi
