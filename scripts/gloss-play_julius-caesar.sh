#!/bin/bash
# gloss-play_julius-caesar.sh - Analyze the entirety of Julius Caesar
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_julius-caesar.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/julius_caesar_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Julius Caesar - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Julius Caesar - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/julius-caesar/"
    exit 0
fi
