#!/bin/bash
# gloss-play_henry-iv-part-2.sh - Analyze the entirety of Henry Iv Part 2
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_henry-iv-part-2.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Henry Iv Part 2 - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Henry Iv Part 2 - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/henry-iv-part-2/"
    exit 0
fi
