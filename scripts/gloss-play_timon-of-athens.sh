#!/bin/bash
# gloss-play_timon-of-athens.sh - Analyze the entirety of Timon of Athens
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_timon-of-athens.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/timon_of_athens_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Timon of Athens - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Timon of Athens - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing Timon of Athens..."
echo "Play file: $PLAY"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/timon-of-athens/"
    exit 0
fi
