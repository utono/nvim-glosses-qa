#!/bin/bash
# gloss-play_cymbeline.sh - Analyze the entirety of Cymbeline
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_cymbeline.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/cymbeline_gut.txt"
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Cymbeline - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/cymbeline/"
    exit 0
fi
