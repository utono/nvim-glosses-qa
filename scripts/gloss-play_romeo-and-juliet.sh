#!/bin/bash
# gloss-play_romeo-and-juliet.sh - Analyze the entirety of Romeo and Juliet
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_romeo-and-juliet.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/romeo_and_juliet_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Romeo and Juliet - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Romeo and Juliet - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing Romeo and Juliet..."
echo "Play file: $PLAY"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/romeo-and-juliet/"
    exit 0
fi
