#!/bin/bash
# gloss-play_twelfth-night.sh - Analyze the entirety of Twelfth Night
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_twelfth-night.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Twelfth Night - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Twelfth Night - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
