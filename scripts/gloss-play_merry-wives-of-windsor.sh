#!/bin/bash
# gloss-play_merry-wives-of-windsor.sh - Analyze the entirety of Merry Wives of Windsor
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_merry-wives-of-windsor.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Merry Wives of Windsor - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Merry Wives of Windsor - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Play: Merry Wives of Windsor"
echo "Total scenes: $TOTAL_SCENES"
