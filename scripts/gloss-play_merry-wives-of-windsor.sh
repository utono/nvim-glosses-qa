#!/bin/bash
# gloss-play_merry-wives-of-windsor.sh - Analyze the entirety of The Merry Wives of Windsor
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_merry-wives-of-windsor.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== The Merry Wives of Windsor - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== The Merry Wives of Windsor - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing The Merry Wives of Windsor..."
echo "Play file: $PLAY"
...
echo "Play: The Merry Wives of Windsor"
echo "Total scenes: $TOTAL_SCENES"
