#!/bin/bash
# gloss-play_john.sh - Analyze the entirety of King John
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_john.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== King John - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
