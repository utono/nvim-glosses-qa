...
#
# Usage: ./gloss-play_coriolanus.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
echo ""
echo "--- Act 1, Scene 3 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 3 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 3 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 3 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 4 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 4 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 4 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 4 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 5 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 5 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 5 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 5 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 6 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 6 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 6 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 6 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 7 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 7 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 7 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 7 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 8 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 8 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 8 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 8 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 9 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 9 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 9 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 9 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 1, Scene 10 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 1 10 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 1, Scene 10 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 1 10 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 5, Scene 4 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 5 4 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 5, Scene 4 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 5 4 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 5, Scene 5 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 5 5 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 5, Scene 5 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 5 5 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
...
echo ""
echo "--- Act 5, Scene 6 ---"
if [ -n "$RESUME_MODE" ] && python "$ANALYZER" "$PLAY" 5 6 --merge "$MERGE" --status 2>/dev/null; then
    echo "[SKIPPED] Act 5, Scene 6 - fully cached"
    ((SKIPPED++))
elif python "$ANALYZER" "$PLAY" 5 6 --merge "$MERGE" $DRY_RUN; then
    ((SUCCESSFUL++))
else
    ((ERRORS++))
    FAILED_SCENES="$FAILED_SCENES
