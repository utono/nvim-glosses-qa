#!/bin/bash
# gloss-play_henry-viii.sh - Analyze the entirety of Henry Viii
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_henry-viii.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Henry Viii - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
