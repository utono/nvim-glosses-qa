#!/bin/bash
# analyze_coriolanus.sh - Analyze the entirety of Coriolanus
# Generated by /analyze-plays command
#
# Usage: ./analyze_coriolanus.sh [--dry-run]
#
...
# Act 1, Scene 8
echo "--- Act 1, Scene 8 ---"
python "$ANALYZER" "$PLAY" 1 8 --merge "$MERGE" $DRY_RUN

# Act 1, Scene 9
echo "--- Act 1, Scene 9 ---"
python "$ANALYZER" "$PLAY" 1 9 --merge "$MERGE" $DRY_RUN

# Act 1, Scene 10
echo "--- Act 1, Scene 10 ---"
python "$ANALYZER" "$PLAY" 1 10 --merge "$MERGE" $DRY_RUN
