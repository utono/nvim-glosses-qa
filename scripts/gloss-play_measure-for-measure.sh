#!/bin/bash
# gloss-play_measure-for-measure.sh - Analyze the entirety of Measure for Measure
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_measure-for-measure.sh [OPTIONS] [FILTER]
#
# Options:
...
PLAY="/home/mlj/utono/literature/shakespeare-william/gutenberg/measure_for_measure_gut.txt"
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Measure for Measure - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Measure for Measure - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing Measure for Measure..."
echo "Play file: $PLAY"
...
if [ "$ERRORS" -gt 0 ]; then
    ...
    echo "Output directory: ~/utono/literature/glosses/measure-for-measure/"
    exit 0
fi
