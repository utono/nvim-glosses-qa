#!/bin/bash
# gloss-play_alls-well-that-ends-well.sh - Analyze the entirety of Alls Well That Ends Well
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_alls-well-that-ends-well.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Alls Well That Ends Well - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Alls Well That Ends Well - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Play: Alls Well That Ends Well"
echo "Total scenes: $TOTAL_SCENES"
