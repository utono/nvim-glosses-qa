#!/bin/bash
# gloss-play_alls-well-that-ends-well.sh - Analyze the entirety of All's Well That Ends Well
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_alls-well-that-ends-well.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== All's Well That Ends Well - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== All's Well That Ends Well - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Analyzing All's Well That Ends Well..."
echo "Play file: $PLAY"
...
echo "Play: All's Well That Ends Well"
echo "Total scenes: $TOTAL_SCENES"
