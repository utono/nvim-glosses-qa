#!/bin/bash
# gloss-play_tempest.sh - Analyze the entirety of Tempest
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_tempest.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Tempest - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
