#!/bin/bash
# gloss-play_tempest.sh - Analyze the entirety of The Tempest
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_tempest.sh [--status] [--dry-run] [--resume] [--validate]
#
# Options:
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== The Tempest - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
