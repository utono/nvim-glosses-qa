#!/bin/bash
# gloss-play_midsummer-nights-dream.sh - Analyze the entirety of Midsummer Nights Dream
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_midsummer-nights-dream.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Midsummer Nights Dream - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Midsummer Nights Dream - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
...
echo "Play: Midsummer Nights Dream"
echo "Total scenes: $TOTAL_SCENES"
