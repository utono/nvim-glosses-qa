#!/bin/bash
# gloss-play_loves-labours-lost.sh - Analyze the entirety of Loves Labours Lost
# Generated by /analyze-plays command
#
# Usage: ./gloss-play_loves-labours-lost.sh [OPTIONS] [FILTER]
#
# Options:
...
if [ -n "$STATUS_ONLY" ]; then
    echo "=== Loves Labours Lost - Cache Status ==="
    echo ""
    CACHED=0
    PENDING=0
...
if [ -n "$VALIDATE_MODE" ]; then
    echo "=== Loves Labours Lost - Validating Script ==="
    echo ""
    VALID=0
    INVALID=0
